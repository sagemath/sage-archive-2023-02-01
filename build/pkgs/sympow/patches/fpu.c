...
Set the FPU 's precion control to 53 bits (double precision) instead of the
64-bits (extended precision). I've commented it fairly librarily, with
the hope it's helpful if anyone needs to edit it.
