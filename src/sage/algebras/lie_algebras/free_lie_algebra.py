...
class FreeLieBasis_abstract(FinitelyGeneratedLieAlgebra, BindableClass):
    """
    ...
    def __init__(self, lie, basis_name):
        ...
        gens = map(LieGenerator, lie._names)
        FinitelyGeneratedLieAlgebra.__init__(self, lie.base_ring(), gens,
    ...
    def basis(self):
        ...
        EXAMPLES::
            ...
            sage: L = LieAlgebra(QQ, 3, 'x')
            sage: L.Hall().basis()
            Disjoint union of Lazy family (Cached version of <function graded_basis at 0x...>(i))_{i in Positive integers}
        """
    ...
    def graded_dimension(self, k):
        ...
        .. [MKO1998] Hans Munthe--Kaas, Brynjulf Owren. *Computations in a
           free Lie algebra*. (1998).
...
class FreeLieAlgebra(Parent, UniqueRepresentation):
    ...
    def __classcall_private__(cls, R, names=None, index_set=None):
        ...
        if index_set is None:
            if names is None:
                raise ValueError("the names or the index set must be specified")
    ...
    def __init__(self, R, names, index_set):
        ...
        Parent.__init__(self, base=R, category=LieAlgebras(R).WithRealizations())
