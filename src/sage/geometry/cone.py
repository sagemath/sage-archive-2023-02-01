...
class ConvexRationalPolyhedralCone(IntegralRayCollection,
    ...
    def __getstate__(self):
        ...
        TESTS::
            ...
            sage: C = Cone([(1,0)])
            sage: C.face_lattice()
            Finite poset containing 2 elements with embedded linear extension
    ...
    def face_lattice(self):
        ...
        lattice of ``cone`` consists of (appropriate) faces of ``supercone``::
            ...
            Finite poset containing 16 elements with embedded linear extension
            ...
            Finite poset containing 8 elements with embedded linear extension
