...
class GradedModularFormElement(Element):
    ...
    def q_expansion(self, prec=None):
        ...
        """
        return sum(f.q_expansion(prec) for f in self._dictionnary().values())
    ...
    def weights(self):
        ...
        """
        return list(self._dictionnary().keys())
