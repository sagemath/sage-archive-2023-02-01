...
class ComplexReflectionGroups(Category_singleton):
    ...
    This is the base category for finite subgroups of the special linear
    group which are generated by reflections.

    A *reflection group* is a finite group `W` generated by (complex)
    ...
    Consider an example of a reflection group::
    ...
    class ParentMethods:
        ...
        def an_element(self):
            ...
            .. WARNING::
                ...
                This is *not* necessarily a Coxeter element, namely when
                ``self`` is not well-generated or not irreducible.
    ...
    class Finite(CategoryWithAxiom):
        ...
        Consider an example of a finite reflection group::
        ...
        class WellGenerated(CategoryWithAxiom):
            r"""
            Consider an example of a complex reflection group::
            ...
            P is in the category of complex reflection groups::
