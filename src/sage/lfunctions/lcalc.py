...
class LCalc(SageObject):
    ...
    def zeros(self, n, L=''):
        ...
        EXAMPLES:
            ...
            [9.22237939, 13.9075498, 17.4427769, 19.6565131, 22.3361036]
            sage: lcalc.zeros(3, EllipticCurve('37a'))     # long
            [0.000000000, 5.00317001, 6.87039121]
        """
        L = self._compute_L(L)
    ...
    def value(self, s, L=''):
        ...
        EXAMPLES:
            ...
            2.69261988 - 0.0203860296*I

        Note, SAGE can also compute zeta at complex numbers (using
        the PARI C library):
            sage: (0.5 + 100*I).zeta()
            2.69261988568132 - 0.0203860296025981*I
        """
        L = self._compute_L(L)
    ...
    def values_along_line(self, s0, s1, number_samples, L=''):
        ...
        EXAMPLES:
            ...
            [(0.500000000, -1.46035450), (0.500000000 + 4.00000000*I, 0.606783764 + 0.0911121399*I), (0.500000000 + 8.00000000*I, 1.24161510 + 0.360047588*I), (0.500000000 + 12.0000000*I, 1.01593665 - 0.745112472*I), (0.500000000 + 16.0000000*I, 0.938545408 + 1.21658781*I)]
        """
        L = self._compute_L(L)
        CC = sage.rings.all.ComplexField(prec)
        s0 = CC(s0)
    ...
    def twist_values(self, s, dmin, dmax, L=''):
        ...
        EXAMPLES:
            ...
            [(-8, 1.10042140), (-7, 1.14658566), (-4, 0.667691457), (-3, 0.480867557), (5, 0.231750947), (8, 0.373691712)]
        """
        L = self._compute_L(L)
        CC = sage.rings.all.ComplexField(prec)
    ...
    def twist_zeros(self, n, dmin, dmax, L=''):
        ...
        EXAMPLES:
            ...
            {-3: [8.03973715, 11.2492062, 15.7046191], 5: [6.64845334, 9.83144443, 11.9588456]}
        """
        L = self._compute_L(L)
        RR = sage.rings.all.RealField(prec)
        Z = sage.rings.all.Integer
