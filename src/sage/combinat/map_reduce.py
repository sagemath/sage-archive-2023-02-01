r"""
Distributed/Paralell computations using SearchForest and Map-Reduce

There exists an easy way to distribute computations when you have a set `S` of
objects defined by a :class:`SearchForest` object (see
...
* Compute the cardinality of a (very large) set defined recursively
  (i.e. through a :class:`SearchForest` object)
...
This implementation is specific to :class:`SearchForest`, and uses its
...
First, you need the information necessary to describe a :class:`SearchForest`
...
* **Counting the number of elements** : In this situation, the map function
  ...
  You don't need to use :class:`SearchForest`, you can use directly
  :class:`SearchForestMapReduce`. This is needed if you want to have fine
  control over the parallel execution (see :ref:`advanced-use` below)::

      sage: from sage.combinat.map_reduce import SearchForestMapReduce
      sage: S = SearchForestMapReduce(
      ....:   roots = [[]],
      ....:   children = lambda l: [l+[0], l+[1]] if len(l) <= 15 else [],
      ....:   map_function = lambda x : 1,
      ....:   reduce_function = lambda x,y: x+y,
...
* On can also compute the list of objects in a :class:`SearchForest` using
  :class:`SearchForestMapReduce`. As an example, ee compute the set of number
  beetween 1 and 63, generated by their binary expansion::

      sage: S = SearchForest( [1],
      ....:    lambda l: [(l<<1)|0, (l<<1)|1] if l < 1<<5 else [],
      ....:    lambda l: l)

  Here is the list computed without :class:`SearchForestMapReduce`::
...
class SearchForestMapReduce(object):
    r"""
    ...
    def __init__(self, roots = None,
        ...
        TESTS::
            ...
            sage: from sage.combinat.map_reduce import SearchForestMapReduce
            sage: R = SearchForestMapReduce( [[]], lambda : [[]])
            sage: R
            <sage.combinat.map_reduce.SearchForestMapReduce object at 0x...>
    ...
    def _forest(self):
        ...
        EXAMPLES::
            ...
            sage: from sage.combinat.map_reduce import SFMPExample
            sage: EX = SFMPExample()
            sage: f = EX._forest; f
            ...
            []
        """
        return SearchForest(self.roots(),
                            self.children,
                            self.post_process)
    ...
    def roots(self):
        ...
        TESTS::
            ...
            sage: from sage.combinat.map_reduce import SearchForestMapReduce
            sage: S = SearchForestMapReduce(42)
            sage: S.roots()
            42
        """
        return self._roots
    ...
    def map_function(self, o):
        ...
        TESTS::
            ...
            1
            sage: S = SearchForestMapReduce(map_function = lambda x: 3*x + 5)
            sage: S.map_function(7)
            26
         """
        return 1
    ...
    def reduce_function(self, a, b):
        ...
        TESTS::
            ...
            7
            sage: S = SearchForestMapReduce(reduce_function=lambda x,y: x*y)
            sage: S.reduce_function(4, 3)
            12
        """
        return a+b
    ...
    def post_process(self, a):
        ...
        TESTS::
            ...
            4
            sage: S = SearchForestMapReduce(post_process=lambda x: x*x)
            sage: S.post_process(4)
            16
        """
        return a
    ...
    def reduce_init(self):
        ...
        TESTS::
            ...
            sage: S.reduce_init()
            0
            sage: S = SearchForestMapReduce(reduce_init = 2)
            sage: S.reduce_init()
            2
        """
    ...
    def start_workers(self):
        ...
        TESTS::
            ...
            sage: from sage.combinat.map_reduce import SearchForestMapReduce
            sage: S = SearchForestMapReduce(roots=[])
            sage: S.setup_workers(2)
    ...
    def abort(self):
        ...
        EXAMPLES::
            ...
            sage: from sage.combinat.map_reduce import SearchForestParallelIterator
            sage: S = SearchForestParallelIterator( [[]],
    ...
    def random_worker(self):
        ...
        EXAMPLES:
            ...
            sage: from sage.combinat.map_reduce import SFMPExample, MapReduceWorker
            sage: from threading import Thread
            sage: EX = SFMPExample(maxl=6)
...
class MapReduceWorker(Process):
    ...
    - ``mapred`` -- the instance of :class:`SearchForestMapReduce` for which
...
class SFMPExample(SearchForestMapReduce):
    r"""
    ...
    def __init__(self, maxl = 9):
        ...
        TESTS::
            ...
            sage: from sage.combinat.map_reduce import SFMPExample
            sage: SFMPExample()
            <sage.combinat.map_reduce.SFMPExample object at 0x...>
        """
    ...
    def map_function(self, z):
        ...
        EXAMPLE::
            ...
            sage: from sage.combinat.map_reduce import SFMPExample
            sage: SFMPExample().map_function([1,0])
            x^2
        """
        return self.x**len(z)


class SearchForestParallelIterator(SearchForestMapReduce):
    r"""
