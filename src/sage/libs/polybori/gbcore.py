from sage.libs.polybori.nf import *

from sage.libs.polybori.PyPolyBoRi import *
from sage.libs.polybori.ll import eliminate, ll_encode
from time import time
from copy import copy
from itertools import chain
from inspect import getargspec
from sage.libs.polybori.statistics import used_vars, used_vars_set
from sage.libs.polybori.heuristics import dense_system, gauss_on_linear
from sage.libs.polybori.easy_polynomials import easy_linear_polynomials
from itertools import chain
from sage.libs.polybori.interpolate import lex_groebner_basis_for_polynomial_via_variety
from inspect import getargspec
from sage.libs.polybori.fglm import _fglm
...
def variety_size_from_gb(I):
    """
    >>> from sage.libs.polybori import Ring, Polynomial, Monomial
    >>> from sage.libs.polybori.gbcore import variety_size_from_gb
    >>> r=Ring(100)
    >>> x = r.variable
...
def other_ordering_pre(I, option_set, kwds):
    ...
    >>> from sage.libs.polybori.gbcore import other_ordering_pre, groebner_basis
