from sage.libs.polybori.PyPolyBoRi import Monomial, random_set, Polynomial, \
set_random_seed, Ring, ll_red_nf_redsb, Variable
from sage.libs.polybori.ll import ll_encode
...
def sparse_random_system(ring, number_of_polynomials,
    ...
    >>> from sage.libs.polybori import Ring, groebner_basis
    >>> from sage.libs.polybori.randompoly import sparse_random_system
    >>> r=Ring(10)
...
def sparse_random_system_data_file_content(
    ...
    r"""
    >>> from sage.libs.polybori.randompoly import sparse_random_system_data_file_content
