...
class FiniteGCAlgebra(CombinatorialFreeModule, Algebra):
    ...
    ring with finite degree satisfying the super-algebra relation w.r.t. the
    degree modulo 2. More precisely, `A` has a graded ring structure

    .. MATH::

        A = \bigoplus_{i=0}^n A_i,

    where `n` is the maximal degree, and the multiplication satisfies
    ...
    Such an algebra is multiplicatively generated by a set of monomials
    ...
    Typical examples of finite dimensional graded commutative algebra are
    ...
    EXAMPLES::
        ...
        sage: A.<x,y,z,t> = GradedCommutativeAlgebra(QQ, degrees=(1,2,2,5), max_degree=10)
        sage: A
        Graded commutative algebra with generators ('x', 'y', 'z', 't') in degrees (1, 2, 2, 5) with maximal finite degree 10
        sage: t*x + x*t
        0
        sage: x^2
        0
    ...
    We can also return the basis::
        ...
        sage: A.basis()
        Finite family {[0, 0, 0, 0]: 1, [1, 0, 0, 0]: x, [0, 0, 1, 0]: z,
         [0, 1, 0, 0]: y, [1, 0, 1, 0]: x*z, [1, 1, 0, 0]: x*y,
         [0, 0, 2, 0]: z^2, [0, 1, 1, 0]: y*z, [0, 2, 0, 0]: y^2, [0, 0, 0, 1]: t,
         [1, 0, 2, 0]: x*z^2, [1, 1, 1, 0]: x*y*z, [1, 2, 0, 0]: x*y^2,
         [1, 0, 0, 1]: x*t, [0, 0, 3, 0]: z^3, [0, 1, 2, 0]: y*z^2,
         [0, 2, 1, 0]: y^2*z, [0, 3, 0, 0]: y^3, [0, 0, 1, 1]: z*t,
         [0, 1, 0, 1]: y*t, [1, 0, 3, 0]: x*z^3, [1, 1, 2, 0]: x*y*z^2,
         [1, 2, 1, 0]: x*y^2*z, [1, 3, 0, 0]: x*y^3, [1, 0, 1, 1]: x*z*t,
         [1, 1, 0, 1]: x*y*t, [0, 0, 4, 0]: z^4, [0, 1, 3, 0]: y*z^3,
         [0, 2, 2, 0]: y^2*z^2, [0, 3, 1, 0]: y^3*z, [0, 4, 0, 0]: y^4,
         [0, 0, 2, 1]: z^2*t, [0, 1, 1, 1]: y*z*t, [0, 2, 0, 1]: y^2*t,
         [1, 0, 4, 0]: x*z^4, [1, 1, 3, 0]: x*y*z^3, [1, 2, 2, 0]: x*y^2*z^2,
         [1, 3, 1, 0]: x*y^3*z, [1, 4, 0, 0]: x*y^4, [1, 0, 2, 1]: x*z^2*t,
         [1, 1, 1, 1]: x*y*z*t, [1, 2, 0, 1]: x*y^2*t, [0, 0, 5, 0]: z^5,
         [0, 1, 4, 0]: y*z^4, [0, 2, 3, 0]: y^2*z^3, [0, 3, 2, 0]: y^3*z^2,
         [0, 4, 1, 0]: y^4*z, [0, 5, 0, 0]: y^5}
