...
Programs (`LP <https://en.wikipedia.org/wiki/Linear_programming>`_) and Mixed
Integer Linear Programs (`MILP
<https://en.wikipedia.org/wiki/Mixed_integer_linear_programming>`_).
...
A linear program (`LP <https://en.wikipedia.org/wiki/Linear_programming>`_)
...
linear program (`MILP <https://en.wikipedia.org/wiki/Mixed_integer_linear_programming>`_).
