...
class IndexedSequence(SageObject):
    ...
    def dct(self):
        ...
        EXAMPLES:
            ...
            Indexed sequence: [2.50000000000012 + 0.000000000000000166533453693773*I, 2.50000000000012 + 0.000000000000000166533453693773*I, 2.50000000000012 + 0.000000000000000166533453693773*I, 2.50000000000012 + 0.000000000000000166533453693773*I, 2.50000000000012 + 0.000000000000000166533453693773*I]
               indexed by [0, 1, 2, 3, 4]
        """
        F = self.base_ring()   ## elements must be coercible into RR
        J = self.index_object()   ## must be = range(N)
    ...
    def dst(self):
        ...
        EXAMPLES:
            ...
            Indexed sequence: [0.000000000000000277555756156289 - 2.49999999999915*I, 0.000000000000000277555756156289 - 2.49999999999915*I, 0.000000000000000277555756156289 - 2.49999999999915*I, 0.000000000000000277555756156289 - 2.49999999999915*I, 0.000000000000000277555756156289 - 2.49999999999915*I]
                indexed by [0, 1, 2, 3, 4]
        """
        F = self.base_ring()   ## elements must be coercible into RR
        J = self.index_object()   ## must be = range(N)
