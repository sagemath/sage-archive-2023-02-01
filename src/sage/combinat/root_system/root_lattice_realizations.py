    ...
    class ParentMethods:
        ...
        def positive_real_roots(self):
            ...
            if self.cartan_type().is_untwisted_affine():
                C = cartesian_product([PositiveIntegers(), FiniteEnumeratedSet(Q.roots())])
                ...
                Cs = cartesian_product([PositiveIntegers(), FiniteEnumeratedSet(Q.short_roots())])
                Cl = cartesian_product([PositiveIntegers(), FiniteEnumeratedSet(Q.long_roots())])
