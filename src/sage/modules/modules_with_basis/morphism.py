...
the image of each element of the distinguished basis::
    ...
    sage: phi1.__class__
    <class 'sage.modules.modules_with_basis.morphism.ModuleMorphismByLinearity_with_category'>
...
compatibility is guaranteed in this case::
    ...
    sage: from sage.modules.modules_with_basis.morphism import ModuleMorphismByLinearity
...
class ModuleMorphismFromFunction(ModuleMorphism, SetMorphism):
    ...
    def __init__(self, domain, function, codomain=None, category=None):
        ...
        TESTS::
            ...
            sage: from sage.modules.modules_with_basis.morphism import ModuleMorphismFromFunction
...
class ModuleMorphismByLinearity(ModuleMorphism):
    ...
    def on_basis(self):
        ...
        EXAMPLES::
            ...
            sage: phi = sage.modules.modules_with_basis.morphism.ModuleMorphismByLinearity(X, on_basis = phi_on_basis, codomain=Y)
            sage: x = X.basis()
            sage: phi.on_basis()(-2)
            B[2]
    ...
    def __call__(self, *args):
        ...
        EXAMPLES::
            ...
            sage: phi = sage.modules.modules_with_basis.morphism.ModuleMorphismByLinearity(X, on_basis = Y.monomial * abs, codomain=Y)
            sage: x = X.basis()
...
class TriangularModuleMorphismByLinearity(ModuleMorphismByLinearity, TriangularModuleMorphism):
    ...
    def __init__(self, domain, on_basis, codomain=None, category=None, **keywords):
        ...
        TESTS::
            ...
            sage: from sage.modules.modules_with_basis.morphism import TriangularModuleMorphismByLinearity
...
class ModuleMorphismFromMatrix(ModuleMorphismByLinearity):
    ...
    EXAMPLES::
        ...
        sage: phi.__class__
        <class 'sage.modules.modules_with_basis.morphism.ModuleMorphismFromMatrix_with_category'>
        sage: phi(x[1])
        B[3] + 3*B[4]
        sage: phi(x[2])
        2*B[3] + 5*B[4]
    ...
    def __init__(self, domain, matrix, codomain=None, category=None, side="left"):
        ...
        TESTS::
            ...
            sage: from sage.modules.modules_with_basis.morphism import ModuleMorphismFromMatrix
            sage: X = CombinatorialFreeModule(ZZ, [1,2]); X.rename("X"); x = X.basis()
            sage: Y = CombinatorialFreeModule(ZZ, [3,4]); Y.rename("Y"); y = Y.basis()
            sage: m = matrix([[1,2],[3,5]])
...
class DiagonalModuleMorphism(ModuleMorphismByLinearity):
    ...
    def __init__(self, domain, diagonal, codomain=None, category=None):
        ...
        TESTS::
            ...
            sage: phi = X.module_morphism(diagonal=factorial, codomain=X)
            sage: phi.__class__
            <class 'sage.modules.modules_with_basis.morphism.DiagonalModuleMorphism_with_category'>
            sage: TestSuite(phi).run()
        """
        if codomain is None:
...
def pointwise_inverse_function(f):
    ...
    EXAMPLES::
        ...
        sage: from sage.modules.modules_with_basis.morphism import pointwise_inverse_function
...
class PointwiseInverseFunction(SageObject):
    ...
    EXAMPLES::
        ...
        sage: from sage.modules.modules_with_basis.morphism import PointwiseInverseFunction
