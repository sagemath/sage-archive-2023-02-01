r"""
    Module for propositional calculus.

    Formulas consist of the operators &, |, ~, ^, ->, <->, corresponding
    to and, or, not, xor, if...then, and if and only if.  Operators can
...
def formula(s):
    r"""
    Formula returns an instance of BooleanFormula if possible, and throws
    ...
    OUTPUT:
        Returns an instance of BooleanFormula.
