...
def _bdd_height_iq(K, height_bound):
    ...
    EXAMPLES::
        ...
        sage: L = _bdd_height_iq(K,1000)        # long time (14 seconds)
...
def _integer_points_in_polytope(matrix, interval_radius):
    ...
    ::
        ...
        sage: r = 2.7
        sage: L = _integer_points_in_polytope(m,r)    # long time (36 seconds)
        sage: len(L)                                  # long time  
        622837
...
def bdd_height(self, height_bound, precision=100, GRH=False):
    ...
    EXAMPLES::
        ...
        sage: K.elements_of_bdd_height(-3)
        []
    ...
    ::
        ...
        sage: K.elements_of_bdd_height(5)
    ...
    ::
        ...
        sage: L = K.elements_of_bdd_height(500)
        sage: len(L)
        3207
