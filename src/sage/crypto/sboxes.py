...
8 bit to 8 bit
    ...
    - Iraqi
    - iScream
    - Kalyna_pi0, ..., Kalyna_pi3
    - Khazad
    - Kuznyechik (Kuznechik, Streebog, Stribog)
    - MD2
    - newDES
    - Picaro
    - Safer
...
4 bit to 4 bit
    - DES_S1_1, ..., DES_S1_4, ..., DES_S8_4
    - Lucifer_S0, Lucifer_S1
    - GOST_1, ..., GOST_8
    - GOST2_1, GOST2_2
    - Magma_1, ..., Magma_8
    - GOST_IETF_1, ..., GOST_IETF_8
    - Hummingbird_2_S1, ..., Hummingbird_2_S4
    - LBlock_0, ..., LBlock_9
    - SERPENT_S0, ..., SERPENT_S7
    - KLEIN
    - MIBS
    - Midori_Sb0 (MANTIS), Midori_Sb1
    - Noekeon
    - Piccolo
    - Panda
    - PRESENT
    ...
    - Anubis_S0, Anubis_S1
    - CLEFIA_SS0, ..., CLEFIA_SS3
    - Enocoro_S4
    - Iceberg_S0, Iceberg_S1
    - Khazad_P, Khazad_Q
    - Whirlpool_E, Whirlpool_R
    - CS_cipher_F, CS_cipher_G
    - Fox_S1, ..., Fox_S3
...
sboxes = {
        ...
        "CLEFIA_S0" : CLEFIA_S0,
        "CLEFIA_S1" : CLEFIA_S1,
        "Crypton_0_5" : Crypton_0_5,
        "Crypton_1_0_S0" : Crypton_1_0_S0,
        "Crypton_1_0_S1" : Crypton_1_0_S1,
        "Crypton_1_0_S2" : Crypton_1_0_S2,
        "Crypton_1_0_S3" : Crypton_1_0_S3,
        "CS_cipher" : CS_cipher,
        "CSA" : CSA,
        "CSS" : CSS,
        "E2" : E2,
        ...
        "Iraqi" : Iraqi,
        "iScream" : iScream,
        "Kalyna_pi0" : Kalyna_pi0,
        "Kalyna_pi1" : Kalyna_pi1,
        "Kalyna_pi2" : Kalyna_pi2,
        "Kalyna_pi3" : Kalyna_pi3,
        "Khazad" : Khazad,
        ...
        "SKINNY_8" : SKINNY_8,
        "Skipjack" : Skipjack,
        "SNOW_3G_sq" : SNOW_3G_sq,
        "SMS4" : SMS4,
        "Turing" : Turing,
        "Twofish_p0" : Twofish_p0,
        "Twofish_p1" : Twofish_p1,
        "Whirlpool" : Whirlpool,
        "Zorro" : Zorro,
        "ZUC_S0" : ZUC_S0,
        "ZUC_S1" : ZUC_S1,
        ...
        "DES_S8_3" : DES_S8_3,
        "DES_S8_4" : DES_S8_4,
        "Lucifer_S0" : Lucifer_S0,
        "Lucifer_S1" : Lucifer_S1,
        "GOST_1" : GOST_1,
        "GOST_2" : GOST_2,
        "GOST_3" : GOST_3,
        "GOST_4" : GOST_4,
        ...
        "Magma_7" : Magma_7,
        "Magma_8" : Magma_8,
        "GOST_IETF_1" : GOST_IETF_1,
        "GOST_IETF_2" : GOST_IETF_2,
        "GOST_IETF_3" : GOST_IETF_3,
        "GOST_IETF_4" : GOST_IETF_4,
        "GOST_IETF_5" : GOST_IETF_5,
        "GOST_IETF_6" : GOST_IETF_6,
        "GOST_IETF_7" : GOST_IETF_7,
        "GOST_IETF_8" : GOST_IETF_8,
        "Hummingbird_2_S1" : Hummingbird_2_S1,
        "Hummingbird_2_S2" : Hummingbird_2_S2,
        "Hummingbird_2_S3" : Hummingbird_2_S3,
        "Hummingbird_2_S4" : Hummingbird_2_S4,
        "LBlock_0" : LBlock_0,
        "LBlock_1" : LBlock_1,
        "LBlock_2" : LBlock_2,
        "LBlock_3" : LBlock_3,
        ...
        "LBlock_8" : LBlock_8,
        "LBlock_9" : LBlock_9,
        "SERPENT_S0" : SERPENT_S0,
        "SERPENT_S1" : SERPENT_S1,
        "SERPENT_S2" : SERPENT_S2,
        "SERPENT_S3" : SERPENT_S3,
        "SERPENT_S4" : SERPENT_S4,
        "SERPENT_S5" : SERPENT_S5,
        "SERPENT_S6" : SERPENT_S6,
        "SERPENT_S7" : SERPENT_S7,
        "KLEIN" : KLEIN,
        "MIBS" : MIBS,
        "Midori_Sb0" : Midori_Sb0,
        "Midori_Sb1" : Midori_Sb1,
        "Noekeon" : Noekeon,
        "Piccolo" : Piccolo,
        "Panda" : Panda,
        "PRESENT" : PRESENT,
        ...
        "PRINCE" : PRINCE,
        "Prost" : Prost,
        "Qarma_sigma0" : Qarma_sigma0,
        "Qarma_sigma1" : Qarma_sigma1,
        "REC_0" : REC_0,
        "Rectangle" : Rectangle,
        "SC2000_4" : SC2000_4,
        "SKINNY_4" : SKINNY_4,
        ...
        "JH_S0" : JH_S0,
        "JH_S1" : JH_S1,
        "SMASH_256_S1" : SMASH_256_S1,
        "SMASH_256_S2" : SMASH_256_S2,
        "SMASH_256_S3" : SMASH_256_S3,
        "Anubis_S0" : Anubis_S0,
        "Anubis_S1" : Anubis_S1,
        "CLEFIA_SS0" : CLEFIA_SS0,
        "CLEFIA_SS1" : CLEFIA_SS1,
        "CLEFIA_SS2" : CLEFIA_SS2,
        "CLEFIA_SS3" : CLEFIA_SS3,
        "Enocoro_S4" : Enocoro_S4,
        "Iceberg_S0" : Iceberg_S0,
        "Iceberg_S1" : Iceberg_S1,
        "Khazad_P" : Khazad_P,
        "Khazad_Q" : Khazad_Q,
        "Whirlpool_E" : Whirlpool_E,
        "Whirlpool_R" : Whirlpool_R,
        "CS_cipher_F" : CS_cipher_F,
        "CS_cipher_G" : CS_cipher_G,
        "Fox_S1" : Fox_S1,
        "Fox_S2" : Fox_S2,
        "Fox_S3" : Fox_S3,
        "Twofish_Q0_T0" : Twofish_Q0_T0,
        "Twofish_Q0_T1" : Twofish_Q0_T1,
        "Twofish_Q0_T2" : Twofish_Q0_T2,
        "Twofish_Q0_T3" : Twofish_Q0_T3,
        "Twofish_Q1_T0" : Twofish_Q1_T0,
        "Twofish_Q1_T1" : Twofish_Q1_T1,
        "Twofish_Q1_T2" : Twofish_Q1_T2,
        "Twofish_Q1_T3" : Twofish_Q1_T3,
        "Kuznyechik_nu0" : Kuznyechik_nu0,
        "Kuznyechik_nu1" : Kuznyechik_nu1,
        "Kuznyechik_sigma" : Kuznyechik_sigma,
        "Kuznyechik_phi" : Kuznyechik_phi,
        "UDCIKMP11" : UDCIKMP11,
        "SEA" : SEA,
