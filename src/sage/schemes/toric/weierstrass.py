...
toric surface. An anticanonical hypersurface defines an elliptic curve
in this ambient space. The purpose of this module is to bring the
hypersurface equation into the short Weierstrass form `y^2 = x^3 + f x
...
It turns out that the anticanonical hypersurface equation of any one
of the above 16 toric surfaces is a specialization (that is, set one
or more of the coefficients to zero) of the following three cases. In
inhomogeneous coordinates, they are
...
..  [ArtinVillegasTate]
    ...
    http://dx.doi.org/10.1016/j.aim.2005.06.004
...
from sage.matrix.constructor import matrix, block_matrix, zero_matrix
...
def Discriminant(polynomial, variables=None):
    ...
    The discrimimant of the elliptic curve.
    ...
    for e in polynomial.exponents():
        ...
        if total_weight is None:
            ...
            if weight_e != total_weight:
                raise ValueError('The polynomial is not homogeneous with weights '+str(weights))
