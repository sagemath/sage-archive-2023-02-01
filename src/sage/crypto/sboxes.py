...
8 bit to 8 bit
    ...
    - SKINNY_8 (ForkSkinny_8, Remus_8, Romulus) ([BJKLMPSSS2016]_)
    - Skipjack ([U.S1998]_)
...
4 bit to 4 bit
    ...
    - Panda ([YWHWXSW2014]_)
    - PRESENT (CiliPadi) ([BKLPPRSV2007]_)
    - GIFT (Fountain_1, HYENA) ([BPPSST2017]_)
    ...
    - SKINNY_4 (ForkSkinny_4, Remus_4) ([BJKLMPSSS2016]_)
    - TWINE ([SMMK2013]_)
...
PHOTON   = SBox([0xC, 0x5, 0x6, 0xB, 0x9, 0x0, 0xA, 0xD, 0x3, 0xE, 0xF, 0x8,
                 0x4, 0x7, 0x1, 0x2])
ORANGE   = PHOTON
