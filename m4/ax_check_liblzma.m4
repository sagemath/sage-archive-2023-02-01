# ===========================================================================
#      ax_check_lzma - derived from
#      https://www.gnu.org/software/autoconf-archive/ax_check_zlib.html
# ===========================================================================
#
# SYNOPSIS
#
#   AX_CHECK_LIBLZMA([action-if-found], [action-if-not-found])
#
# DESCRIPTION
#
...
#   Copyright (c) 2018 Dima Pasechnik <dima@pasechnik.info>
#
...
AU_ALIAS([CHECK_LZMA], [AX_CHECK_LZMA])
