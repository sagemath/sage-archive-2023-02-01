...
- :class:`algebras.ArikiKoike <sage.combinat.ariki_koike_algebra.ArikiKoikeAlgebra>`
...
lazy_import('sage.algebras.ariki_koike_algebra', 'ArikiKoikeAlgebra', 'ArikiKoike')
