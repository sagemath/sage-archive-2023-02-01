...
* :class:`PathModel <sage.combinat.crystals.infinity_path_model.InfinityPathModel>`
...
from sage.combinat.crystals.infinity_path_model import InfinityPathModel as PathModel
