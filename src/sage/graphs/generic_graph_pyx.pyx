...
def lex_DFS_fast(G, reverse=False, tree=False, initial_vertex=None):
    r"""
    ...
    A Lex DFS is obviously an ordering of the vertices::
        ...
        sage: from sage.graphs.generic_graph_pyx import lex_DFS_fast
        sage: g = graphs.CompleteGraph(6)
        sage: len(lex_DFS_fast(g)) == g.order()
        True
    ...
    The method also works for directed graphs
        ...
        sage: from sage.graphs.generic_graph_pyx import lex_DFS_fast
        sage: G = DiGraph([(1, 2), (2, 3), (1, 3)])
        sage: lex_DFS_fast(G, initial_vertex=2)
        [2, 3, 1]
