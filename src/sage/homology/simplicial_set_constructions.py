...
class Factors(object):
    ...
    attribute. This is used by :class:`class ProductOfSimplicialSets`,
    :class:`WedgeOfSimplicialSets`, and
    :class`DisjointUnionOfSimplicialSets`.
    """
    def factors(self):
        """
        The factors involved in this construction of simplicial sets.
    ...
    def factor(self, i):
        r"""
        The $i$-th factor of this construction of simplicial sets.
...
class ProductOfSimplicialSets(PullbackOfSimplicialSets, Factors):
    def __init__(self, factors=None):
        ...
        :meth:`factors`. If it is constructed as a product and then
    ...
    def n_skeleton(self, n):
        ...
        In the finite case, this computes the ordinary
        `n`-skeleton. In the infinite case, it computes the
        `n`-skeleton of the product of the `n`-skeleta of the factors.
...
class DisjointUnionOfSimplicialSets(PushoutOfSimplicialSets, Factors):
    def __init__(self, factors=None):
        r"""
        The disjoint union of simplicial sets.
...
class ConeOfSimplicialSet(SimplicialSet_arbitrary):
    def __init__(self, X):
        r"""
        The unreduced cone on a finite simplicial set.
