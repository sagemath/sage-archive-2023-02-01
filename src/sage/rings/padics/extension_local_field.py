class LocalFieldExtension(algebraic_field_extension.AlgebraicFieldExtension):
    def __init__(self, ground, poly): pass
    def _mul_(self, right): pass
    def automorphisms(self): pass
    def base_ring(self): pass
    def composite(self, right): pass
    def defining_polynomial(self): pass
    def degree(self): pass
    def different(self): pass
    def discriminant(self): pass
    def e(self): pass
    def extension_ring(self): pass
    def f(self): pass
    ...
    def is_isomorphic(self): pass
    def is_normal(self): pass
    def norm_equation(self, x): pass #finds an element upstairs with given norm
    ...
    def residue_class_field_extension(self): pass
    def teichmuller(self, x): pass
    def teichmuller_system(self, x): pass
    def totally_ramified_part(self): pass
    def uniformizer(self): pass
    def unit_group(self): pass
    def unit_group_gens(self): pass
    def unramified_part(self): pass
