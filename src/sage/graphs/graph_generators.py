...
###########################################################################
    ...
    import sage.graphs.generators.families_pyx
    ...
    CaiFurerImmermanGraph_Pyx  = staticmethod(sage.graphs.generators.families_pyx.CaiFurerImmermanGraph)
    ...
    EgawaGraph_Pyx         = staticmethod(sage.graphs.generators.families_pyx.EgawaGraph)
    ...
    FurerGadget_Pyx        = staticmethod(sage.graphs.generators.families_pyx.FurerGadget)
    ...
    HammingGraph_Pyx       = staticmethod(sage.graphs.generators.families_pyx.HammingGraph)
