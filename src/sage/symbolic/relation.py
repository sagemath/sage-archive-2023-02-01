...
def solve(f, *args, **kwds):
    ...
    EXAMPLES::
        ...
        [{y: -1/2*sqrt(-I*sqrt(3) + 3)*sqrt(2), x: -1/2*I*sqrt(3) - 1/2}, {y: 1/2*sqrt(-I*sqrt(3) + 3)*sqrt(2), x: -1/2*I*sqrt(3) - 1/2}, {y: -1/2*sqrt(I*sqrt(3) + 3)*sqrt(2), x: 1/2*I*sqrt(3) - 1/2}, {y: 1/2*sqrt(I*sqrt(3) + 3)*sqrt(2), x: 1/2*I*sqrt(3) - 1/2}, {y: -1, x: 0}, {y: 1, x: 0}]
