...
#from sage.misc.
from sageinspect import _sage_getdoc_unformatted, sage_getargspec, isclassinstance
#load("/home/simon/SAGE/work/cohomology/documentation/common/sageinspect.py")
...
class FunctionDocumenter(ModuleLevelDocumenter):
    ...
    def format_args(self):
        ...
        argspec = sage_getargspec(self.object)
