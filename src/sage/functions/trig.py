...
class Function_arccot(BuiltinFunction):
    ...
    def _evalf_(self, x, parent=None, algorithm=None):
        ...
        Test complex input::
            ...
            sage: arccot(complex(1,1))  # rel tol
...
class Function_arccsc(BuiltinFunction):
    ...
    def _evalf_(self, x, parent=None, algorithm=None):
        ...
        Test complex input::
            ...
            sage: arccsc(complex(1,1))  # rel tol
...
class Function_arcsec(BuiltinFunction):
    ...
    def _evalf_(self, x, parent=None, algorithm=None):
        ...
        Test complex input::
            ...
            sage: arcsec(complex(1,1))  # rel tol
