...
from sage.structure.element import ModuleElement, RingElement, parent
...
class LazySpecialFunctions():
    r"""
    A class for lazily computing special functions.
    ...
    The cosine of a series can be found. ::

        sage: cos(z)
        1 - 1/2*z^2 + 1/24*z^4 - 1/720*z^6 + O(z^7)

    The tangent of a series can be found. ::
    ...
    The cosh of a series can be found. ::
    ...
    The arccosine of a series can be found. ::
        ...
        sage: arccos(z)
        3.14159265358979 - 1.00000000000000*z + 0.000000000000000*z^2 - 0.166666666666667*z^3 + 0.000000000000000*z^4 - 0.0750000000000000*z^5 + O(1.00000000000000*z^7)
    ...
    def arccos(self):
        ...
        EXAMPLES::
            ...
            3.14159265358979 - 1.00000000000000*z + 0.000000000000000*z^2 - 0.166666666666667*z^3 + 0.000000000000000*z^4 - 0.0750000000000000*z^5 + O(1.00000000000000*z^7)
            sage: arccos(z^2)                                                                             
            3.14159265358979 + 0.000000000000000*z - 1.00000000000000*z^2 - 0.000000000000000*z^3 + 0.000000000000000*z^4 + 0.000000000000000*z^5 - 0.166666666666667*z^6 + O(1.00000000000000*z^7)
            sage: arccos(z + z^2)                                                                         
            3.14159265358979 - 1.00000000000000*z - 1.00000000000000*z^2 - 0.166666666666667*z^3 - 0.500000000000000*z^4 - 0.575000000000000*z^5 - 0.541666666666667*z^6 + O(1.00000000000000*z^7)
            sage: arccos(1 + z)
            Traceback (most recent call last):
            ...
            ValueError: can only compose with a positive valuation series
        ...
        def coeff(n):
            if n == 0:
                return pi
            if n % 2:
                return -1 * factorial(n-1)/((4**((n-1)/2))*(factorial((n-1)/2)**2)*n)
            return ZZ.zero()
        arccos = P(coeff, 0)
        return arccos(self)
    ...
    def sinh(self):
        ...
        P = self.parent()
        def coeff(n):
            return 1/factorial(n) if n % 2 else ZZ.zero()
        sinh = P(coeff, 0)
        return sinh(self)
    ...
    def tan(self):
        ...
        def coeff(n):
            if n % 2:
                a = QQ((bernoulli(n + 1)) * ((-4) ** ((n + 1)/2)))
                b = QQ(a * QQ((1 - (4 ** ((n + 1)/2)))))
                c = QQ(b / (factorial(n + 1)))
                return c
            return ZZ.zero()
        tan = P(coeff, 0)
        return tan(self)
...
class LazyLaurentSeries(LazySequencesModuleElement, LazyCauchyProductSeries, LazySpecialFunctions):
    ...
    def revert(self):
        ...
        P = self.parent()
        z = P.gen()
        g = self if self._coeff_stream._approximate_valuation == 1 else self * z**(1 - self._coeff_stream._approximate_valuation)
        f = P(None, valuation=1)
        f.define(z/((g/z)(f)))
        return f if self._coeff_stream._approximate_valuation == 1 else f / z**(1 - self._coeff_stream._approximate_valuation)
