...
{	if (coeffs)
	...
	coeffs = new std::vector<Number_T>[4];
	std::vector<Number_T> coeffs_12(12);
	...
	std::vector<Number_T> coeffs_30(30);
	...
	std::vector<Number_T> coeffs_60(60);
	...
	std::vector<Number_T> coeffs_120(120);
