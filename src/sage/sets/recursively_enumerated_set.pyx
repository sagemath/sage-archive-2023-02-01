...
cdef class RecursivelyEnumeratedSet_generic(Parent):
    ...
    def _breadth_first_search_iterator_from_graded_component_iterator(self, max_depth=None):
        ...
        This method is the default breadth first search iterator when the structure is 
        symmetric or graded.
        ...
        .. NOTE::
            ...
            Calling next in this iterator will be either quite slow or very fast since 
            it generates the whole graded component before yielding the elements of
