...
AUTHOR:
    The PolyBoRi Team, 2007-2012
            ...
            >>> from sage.libs.polybori import declare_ring
            >>> from sage.rings.polynomial.pbori import order_dict
            ...
            >>> r = r.clone(ordering=order_dict['dlex'])
            >>> r(x0) > r(x1)
            True
            >>> r(x0) > r(x1*x2)
            False

            >>> r = r.clone(ordering=order_dict['dp_asc'])
            >>> r(x0) > r(x1)
            False
            >>> r(x0) > r(x1*x2)
            False

            >>> r = r.clone(ordering=order_dict['block_dlex'], blocks=[3])
            >>> r(x0) > r(x1)
            True
            >>> r(x0) > r(x1*x2)
            False
            ...
            >>> r = r.clone(ordering=order_dict['block_dp_asc'])
            >>> r(x0) > r(x1)
            False
            >>> r(x0) > r(y0)
            False
            ...
            >>> r = r.clone(ordering=order_dict['block_dp_asc'], blocks=[3])
            >>> r(x0) > r(y0)
            True
...
if _sageify:
    ...
    try:
        ...
        from sage.libs.polybori.dynamic.PyPolyBoRi import *
