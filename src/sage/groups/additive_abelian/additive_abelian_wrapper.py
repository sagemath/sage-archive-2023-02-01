...
class AdditiveAbelianGroupWrapper(addgp.AdditiveAbelianGroup_fixed_gens):
    ...
    def _element_constructor_(self, x, check=False):
        ...
        EXAMPLES::
            ...
            (6, 2)
            sage: G([1,1])
            doctest:...: DeprecationWarning: The default behaviour changed ! If you *really* want a linear combination of smith generators, use .linear_combination_of_smith_form_gens.
