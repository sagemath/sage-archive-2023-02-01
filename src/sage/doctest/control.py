...
class DocTestController(SageObject):
    ...
    def test_safe_directory(self, dir=None):
        ...
        with open(os.devnull, 'w') as dev_null:
            if subprocess.call(['sage-python23', '-Werror', '-c', ''],
    ...
    def _assemble_cmd(self):
        ...
        EXAMPLES::
            ...
            sage-python23 "...sage-runtests" --serial --timeout=123 hello_world.py
        """
        cmd = '''sage-python23 "%s" --serial '''%(os.path.join(SAGE_LOCAL,"bin","sage-runtests"))
    ...
    def run_val_gdb(self, testing=False):
        ...
        expand them here and risk insufficient quoting. ::
            ...
            exec gdb -x "...sage-gdb-commands" --args sage-python23 "...sage-runtests" --serial --timeout=0 hello_world.py
