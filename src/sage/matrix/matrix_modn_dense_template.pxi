...
cdef inline linbox_echelonize(celement modulus, celement* entries, Py_ssize_t nrows, Py_ssize_t ncols):
    ...
    ::
        ...
        sage: A = random_matrix(Integers(10), 10, 20); A
        [1 8 0 7 7 8 0 5 9 1 3 6 7 1 5 9 6 1 1 6]
        [2 7 2 7 3 7 8 3 9 3 6 1 3 4 4 8 1 9 1 1]
        [8 6 2 1 0 0 9 0 9 1 1 2 6 8 5 7 6 3 7 0]
        [9 8 7 4 8 0 0 8 0 3 8 4 4 8 5 1 7 9 9 7]
        [3 5 9 2 2 0 6 7 1 7 4 0 9 4 3 6 8 3 5 1]
        [2 8 3 7 7 6 9 4 2 7 6 5 7 0 4 8 6 7 5 3]
        [1 4 1 2 5 3 4 8 1 3 7 5 8 9 7 8 7 6 8 1]
        [5 1 8 4 6 3 8 8 1 3 4 8 4 0 7 8 7 7 5 9]
        [7 9 6 7 4 3 7 1 0 3 1 7 5 0 4 2 1 7 1 7]
        [3 7 1 8 2 2 6 0 1 8 9 3 4 8 1 0 6 3 3 8]
    ...
    ::
        ...
        sage: A = random_matrix(Integers(10000), 10, 20); A
        [2286 1825 2376 1180 1432 3070 5298 1485 2315   11  486 8911  669 2420 8838 9006 5606 1815 1700 3259]
        [5553 3349 3416 9701  784 2614 7654   74 7642 7631 3667 7491 5417 8046  235 1350 8458 1781 7254 3230]
        [3899 2557 9043 1740 4704  408 5572 2540 6823 2684 2483 6333 6137 2803 5750 7792 5897 3759 6960 1399]
        [3576 6431 1352 9019  632 5164 6432 9946 9449  665 3808 8426 5446 1299 6781 8902 3723 9639 4571 5725]
        [7153 7274 4275 5090 7116  504 2323 8981 7961 6643 4822 8069 7183 2766 9492 2429 9059 2620 9328 6563]
        [4730 3360 8630 3700 1781 5762 1988 3441  487 6869 7931 2534 2783 4002 4040 9831 7860  925 8792 1284]
        [8437 3824 3088 2626 6094 9571 7214 2194 2261 7330 7443 8896 4586 6386 2736 4395 4433 7213 7654 5854]
        [2256 7334 3566 7224 8490 4137 2690 2999  609 7291 7241  908 4810 5162 4079 5581 5198 2563 7058  910]
        [ 160 5757 3867 1620 3893 5557 2491 5934 4831 9953 5663 8183 1187 9725 3137 3159 1374 5277 8498 5701]
        [2640 2586 7674 3417 4878 7052 9606 7388  459 9237 9381 9652  604 5572 2728 4393 4059 8574 7845 7072]
...
cdef class Matrix_modn_dense_template(matrix_dense.Matrix_dense):
    ...
    def _pickle(self):
        ...
        The upcoming buffer protocol would be useful to not have to do
        any copying.
    ...
    cdef Vector _matrix_times_vector_(self, Vector v):
        if not isinstance(v, Vector_modn_dense):
            return matrix_dense.Matrix_dense._matrix_times_vector(self, v)
    ...
    def charpoly(self, var='x', algorithm='linbox'):
        ...
        -  ``algorithm`` - 'generic', 'linbox' or 'all' (default)
    ...
    def echelonize(self, algorithm="linbox", **kwds):
        ...
        - ``'all'`` - compute using both algorithms and verify that
           the results are the same (for the paranoid).
