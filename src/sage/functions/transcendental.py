...
def zeta_symmetric(s):
    ...
    EXAMPLES:
        ...
        0.000201294444235257 + 0.00000000000000000143656787854329*I
        sage: zeta_symmetric(RR('0.5') + I*RR('14.1'))
        0.0000489893483255689 - 0.0000000000000000000440457132572236*I
        sage: zeta_symmetric(RR('0.5') + I*RR('14.2'))
        -0.0000868931282618784 - 0.00000000000000000346605882016459*I
