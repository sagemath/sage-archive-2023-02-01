...
def _test_preprocess_list(R, L):
    ...
    EXAMPLES::
        ...
        sage: _test_preprocess_list(ZqCA(25,names='a'), [1,2,3])
        ([1, 2, 3], 0, None)
        sage: _test_preprocess_list(ZqCA(25,names='a'), [10,20,30])
        ([10, 20, 30], 0, None)
        sage: _test_preprocess_list(ZqCA(25,names='a'), [1/5,2/5,3])
        ([1, 2, 15], -1, NTL modulus 95367431640625)
        sage: _test_preprocess_list(ZqCA(25,names='a'), [1/5,mod(2,625),3])
        ([1, 10, 15], -1, NTL modulus 3125)
        sage: _test_preprocess_list(ZqCA(25,names='a'), [1/5,mod(2,625),ntl_ZZ_p(3,25)])
        ([1, 10, 15], -1, NTL modulus 125)
        sage: _test_preprocess_list(ZqCA(25,names='a'), [1/5,mod(2,625),Zp(5)(5,3)])
        ([1, 10, 1], -1, NTL modulus 625)
        sage: _test_preprocess_list(ZqCA(25,names='a'), [1/5,mod(2,625),Zp(5)(5,3),0])
        ([1, 10, 1, 0], -1, NTL modulus 625)
        sage: _test_preprocess_list(ZqCA(25,names='a'), [1/5,mod(2,625),Zp(5)(5,3),mod(0,3125)])
        ([1, 10, 1, 0], -1, NTL modulus 625)
    """
