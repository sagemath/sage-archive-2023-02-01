...
def isogenies_prime_degree_genus_0(E, l=None):
    ...
    if l is None:
        return sum([isogenies_prime_degree_genus_0(E, ell) for ell in [2,3,5,7,13]],[])
...
def isogenies_prime_degree_genus_plus_0(E, l=None):
    ...
    """
    if l is None:
        return sum([isogenies_prime_degree_genus_plus_0(E, ell) for ell in hyperelliptic_primes],[])
