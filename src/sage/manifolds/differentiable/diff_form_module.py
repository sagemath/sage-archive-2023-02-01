...
class DiffFormModule(UniqueRepresentation, Parent):
    ...
    Module of 2-forms on a non-parallelizable 2-dimensional manifold::
        ...
        sage: type(A)
        <class 'sage.manifolds.differentiable.diff_form_module.DiffFormModule_with_category'>
        sage: latex(A)
    ...
    The module `\Lambda^1(M)` is nothing but the dual of `\mathcal{X}(M)`
    ...
    of the differential form to some subset of its domain::
        ...
        Free module /\^2(U) of 2-forms on the Open subset U of the
    ...
    def __init__(self, vector_field_module, degree):
        ...
        latex_name = r"\Lambda^{" + str(degree) + r"}\left(" + domain._latex_name
    ...
    def base_module(self):
        ...
        EXAMPLES::
            ...
            Module /\^2(U) of 2-forms on the Open subset U of the 3-dimensional
             differentiable manifold M
...
class DiffFormFreeModule(ExtPowerFreeModule):
    ...
    Free module of 2-forms on a parallelizable 3-dimensional manifold::
        ...
        Free module /\^2(M) of 2-forms on the 3-dimensional differentiable
         manifold M
        sage: type(A)
        <class 'sage.manifolds.differentiable.diff_form_module.DiffFormFreeModule_with_category'>
        sage: latex(A)
        \Lambda^{2}\left(M\right)
    ...
    `A` is a module over the algebra `C^k(M)` of (differentiable)
    scalar fields on `M`::
    ...
    A is a *parent* object, whose elements are 2-forms::
    ...
    restrictionof the differential form to some subset of its domain::
