...
def _find_zeros_mod_p_odd(long long a, long long b, long long c, long long r, long long s, long long t, long long p, v):
    ...
    The prime p doesn't divide the discriminant of the form.
...
def _find_zeros_mod_p(a, b, c, r, s, t, p):
    """
    Finds the zeros mod p of the ternary quadratic form.

    The quadratic form is given by the coefficients (a, b, c, r, s,
    t), where p is a prime that doesn't divide the discriminant of the
    form.
