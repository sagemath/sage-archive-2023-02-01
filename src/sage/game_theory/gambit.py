...
however due to the preparser in Sage to use these integers must first be
converted to Python integers.

Here is an example showing a construction of the Prisoners Dilemma::
...
If we solver this with the `LCP` solver we get the required Nash equilibrium::
