...
#from sage.rings.padics.eisenstein_extension_element import EisensteinExtensionElement
...
class EisensteinRingExtensionCappedAbsolute(EisensteinExtensionGeneric, pAdicRingExtensionGeneric):
    r"""
    Eisenstein Extension of a p-adic ring with capped absolute precision
