...
class HomologyVectorSpaceWithBasis(CombinatorialFreeModule):
    ...
    def _to_cycle_on_basis(self, i):
        ...
        EXAMPLES::
            ...
            \chi_(2, 4) + \chi_(2, 5) + \chi_(2, 8) + \chi_(10, 2)
            + \chi_(3, 4) + \chi_(3, 6) + \chi_(3, 8) + \chi_(3, 9)
            + \chi_(4, 5) + \chi_(4, 6) + \chi_(11, 4) + \chi_(5, 7)
            + \chi_(5, 9) + \chi_(6, 7) + \chi_(10, 6) + \chi_(7, 8)
            + \chi_(10, 9)
            sage: H._to_cycle_on_basis((2,0))
            \chi_(3, 5, 9) + \chi_(10, 3, 6) + \chi_(10, 3, 9) + \chi_(4, 5, 7)
            + \chi_(4, 5, 9) + \chi_(4, 6, 7) + \chi_(10, 6, 7)
