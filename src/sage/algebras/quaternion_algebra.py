...
def QuaternionAlgebra(K, a, b, denom=1, names=None):
    """
...
def QuaternionAlgebraWithInnerProduct(K, norms, traces, names = None):
    """
    """
    (n1,n2,n3) = norms
...
def QuaternionAlgebraWithGramMatrix(K, gram, names = None):
    """
    """
...
def QuaternionAlgebraWithDiscriminants(D1, D2, T, M=2, names=None):
    r"""
