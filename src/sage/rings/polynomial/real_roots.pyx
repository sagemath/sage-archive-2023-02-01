...
def real_roots(p, bounds=None, seed=None, skip_squarefree=False, do_logging=False, wordsize=32, retval='rational', strategy=None, max_diameter=None):
    ...
    EXAMPLES:
        ...
        [(0.?e-17, 1), (1.0000000000000000?, 1), (2.0000000000000000?, 1)]
        sage: v = 2^40
        ...
        [(-1.4142135623730950?, 1), (1.414213562373095?, 1)]
        ...
        [(-3.000000000000000?, 1), (-1.000000000000000?, 1), (0.?e-17, 1), (1.000000000000000?, 1), (2.000000000000000?, 1)]
