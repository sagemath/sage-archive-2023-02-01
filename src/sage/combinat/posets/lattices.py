...
.. csv-table::
    ...
    :meth:`~FiniteLatticePoset.quotient` | Return the quotient lattice of a congruence.
"""
#*****************************************************************************
...
class FiniteLatticePoset(FiniteMeetSemilattice, FiniteJoinSemilattice):
    ...
    def quotient(self, congruence, element_constructor='tuple'):
        ...
        - ``element_constructor``, a string -- whether to have elements
          of the result to be tuples or sublattices of the lattice, or
          just return a lattice on integers isomorphic to the quotient
          lattice
