...
``maj-enter`` pour évaluer le contenu d'une cellule. Vous pouvez même
éditer le contenu avant d'appuyer sur ``maj-entrée``. Sur certains Macs,
il vous faudra peut-être appuyer sur ``maj-return`` plutôt que
``maj-entrée``).
