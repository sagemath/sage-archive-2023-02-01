...
class ClusterQuiver(SageObject):
    ...
    def d_vector_fan(self):
        ...
        It is the fan whose maximal cones are generated by the d-matrices of the
        clusters.

        This is a complete simplicial fan (and even smooth when the initial quiver
        is acyclic). It only makes sense for quivers of finite type.
    ...
    def g_vector_fan(self):
        ...
        It is the fan whose maximal cones are generated by the g-matrices of the
        clusters.

        This is a complete simplicial fan. It is only supported for quivers of
        finite type.
