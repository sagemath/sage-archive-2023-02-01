...
class FunctionFieldOrder_basis(FunctionFieldOrder):
    ...
    def ideal_with_gens_over_base(self, gens, ideal_class=None):
        ...
        m = self.ideal_monoid()
        m.Element = ideal_class

        return m.element_class(self, M)
...
class FunctionFieldMaximalOrder_rational(FunctionFieldMaximalOrder):
    ...
    def ideal(self, *gens):
        ...
        return m.element_class(self, gen)
...
class FunctionFieldMaximalOrder_global(FunctionFieldMaximalOrder):
    ...
    def __init__(self, field):
        ...
        TESTS::
            ...
            sage: TestSuite(O).run(skip=['_test_divides', '_test_one', '_test_prod', '_test_zero'])
        """
    ...
    def _ideal_from_vectors_and_denominator(self, vecs, d=1, check=True):
        ...
        m = self.ideal_monoid()
        m.Element = FunctionFieldIdeal_global
        return m.element_class(self, hnf, d)
    ...
    def gen(self, n=0):
        ...
        EXAMPLES::
            ...
            Traceback (most recent call last):
            ...
            IndexError: Only 3 generators
        """
        if not ( n >= 0 and n < self.ngens() ):
            raise IndexError("Only {} generators".format(self.ngens()))
...
class FunctionFieldMaximalOrderInfinite_rational(FunctionFieldMaximalOrderInfinite):
    ...
    def ideal(self, *gens):
        ...
        m = self.ideal_monoid()
        m.Element = FunctionFieldIdealInfinite_rational
        return m.element_class(self, gen)
...
class FunctionFieldMaximalOrderInfinite_global(FunctionFieldMaximalOrderInfinite):
    ...
    def ideal_with_gens_over_base(self, gens):
        ...
        m = self.ideal_monoid()
        m.Element = FunctionFieldIdealInfinite_global
        return m.element_class(self, ideal)
