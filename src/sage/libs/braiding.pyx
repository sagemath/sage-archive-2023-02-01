...
def greatestcommondivisor(braid1, braid2):
    ...
    A list of lists representing the gcd of p ``braid1`` and ``braid2``
...
def leastcommonmultiple(braid1, braid2):
    ...
    A list of lists representing the lcm of p ``braid1`` and ``braid2``
...
def centralizer(braid):
    ...
    A list of lists representing the generators of the centralizer of ``braid``.
...
def ultrasummitset(braid):
    ...
    A list of lists of lists representing the orbits of the ultra summit set of ``braid``.
...
def sliding_circuits(braid):
    ...
    A list with the sliding circuits of ``braid``. Each sliding circuit is a list of braids.
