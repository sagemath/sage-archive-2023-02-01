...
.. csv-table::
    ...
    :meth:`~FiniteMeetSemilattice.meet_subsemilattice` | Return meet-subsemilattice generated by list of elements.
...
class FiniteMeetSemilattice(FinitePoset):
    ...
    def meet_subsemilattice(self, elms):
        r"""
        ...
        EXAMPLES::
            ...
            sage: L_ = L.meet_subsemilattice([200, 250, 125]); L_
