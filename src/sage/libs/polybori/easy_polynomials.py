from sage.libs.polybori.interpolate import variety_lex_leading_terms, nf_lex_points
from sage.libs.polybori.PyPolyBoRi import easy_linear_factors


def easy_linear_polynomials(p):
    """ Get linear polynomials implied by given polynomial.

    >>> from sage.libs.polybori import VariableFactory, Ring
    >>> from sage.libs.polybori.easy_polynomials import easy_linear_polynomials
    >>> x = VariableFactory(Ring(10000))
...
def easy_linear_polynomials_via_interpolation(p):
    ...
    >>> from sage.libs.polybori import VariableFactory, Ring
    >>> from sage.libs.polybori.easy_polynomials import easy_linear_polynomials_via_interpolation
    >>> x = VariableFactory(Ring(10000))
