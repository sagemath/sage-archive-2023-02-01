...
* :class:`Minimaj <from sage.combinat.multiset_partition_ordered.MinimajCrystal>`
...
from sage.combinat.multiset_partition_ordered import MinimajCrystal as Minimaj
