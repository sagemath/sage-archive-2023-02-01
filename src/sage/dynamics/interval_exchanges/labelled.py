...
class LabelledPermutation(SageObject):
    ...
    def __getitem__(self,i):
        ...
        TESTS::
            ...
            'a'
        """
        return list(map(self._alphabet.unrank, self._intervals[i]))
    ...
    def list(self):
        ...
        Recovering the permutation::
            ...
            True
        """
        a0 = list(map(self._alphabet.unrank, self._intervals[0]))
        a1 = list(map(self._alphabet.unrank, self._intervals[1]))
        return [a0, a1]
...
def LabelledPermutationsIET_iterator(nintervals=None,
    ...
    if not irreducible:
        ...
        P = list(map(g, Permutations(nintervals)))
...
class FlippedLabelledPermutation(LabelledPermutation):
    ...
    def list(self, flips=False):
        ...
        """
        if flips:
            a0 = zip(list(map(self._alphabet.unrank, self._intervals[0])), self._flips[0])
            a1 = zip(list(map(self._alphabet.unrank, self._intervals[1])), self._flips[1])
        else:
            a0 = list(map(self._alphabet.unrank, self._intervals[0]))
            a1 = list(map(self._alphabet.unrank, self._intervals[1]))
    ...
    def __getitem__(self,i):
        ...
        letters = list(map(self._alphabet.unrank, self._intervals[i]))
        flips = self._flips[i]
