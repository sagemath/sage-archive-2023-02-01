...
and reducing is done on different processors but also **generating the list of
members of** `S`.
...
your set `S` (see :mod:`this module
<sage.sets.recursively_enumerated_set>`). Then, you need to provide a Map
