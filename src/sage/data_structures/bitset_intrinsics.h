...
inline int _bitset_isempty(uint64_t* bits, size_t limbs){
    /*
...
inline int _bitset_eq(uint64_t* a, uint64_t* b, size_t limbs){
    /*
...
inline int _bitset_issubset(uint64_t* a, uint64_t* b, size_t limbs){
    /*
...
inline int _bitset_are_disjoint(uint64_t* a, uint64_t* b, size_t limbs){
    /*
...
inline long _bitset_first_in_limb(uint64_t limb){
    /*
...
inline long _bitset_len(uint64_t* bits, size_t limbs){
    /*
...
inline void _bitset_intersection(uint64_t* dst, uint64_t* a, uint64_t* b, size_t limbs){
    /*
...
inline void _bitset_union(uint64_t* dst, uint64_t* a, uint64_t* b, size_t limbs){
    /*
...
inline void _bitset_difference(uint64_t* dst, uint64_t* a, uint64_t* b, size_t limbs){
    /*
...
inline void _bitset_symmetric_difference(uint64_t* dst, uint64_t* a, uint64_t* b, size_t limbs){
    /*
