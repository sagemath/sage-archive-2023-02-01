# -*- coding: utf-8 -*-
#
# p-group cohomology documentation build configuration file, created by
# sphinx-quickstart on Tue Jun  9 09:28:16 2009.
#
...
SAGE_DOC = os.path.join(os.environ['SPKG_ROOT'],'doc')
...
def setup(app):
    ...
    app.config.autodoc_builtin_argspec =  sage_getargspec
