...
""".format(heading, __file__, module_name)
    ...
    def _doctrees_dir(self):
        """
        Return the directory where the doctrees are stored.  If the
...
def help_usage(s="", compact=False):
    """
    Append and return a brief usage message for the Sage
...
def help_description(s="", compact=False):
    """
    Append and return a brief description of the Sage documentation
...
def help_examples(s=""):
    """
    Append and return some usage examples for the Sage documentation
    builder.
    """
    s += "Examples:\n"
