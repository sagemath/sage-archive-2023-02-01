...
SAGE_SPKG_CONFIGURE_BASE([gcc], [
    ...
    if test "x$ORIGINAL_CXXFLAGS" = "x"; then
        ...
        AC_SUBST(CXXFLAGS_03, "$ORIGINAL_CXXFLAGS")
        AC_SUBST(CXXFLAGS_NON_NATIVE, "$ORIGINAL_CXXFLAGS")
        AC_SUBST(CXXFLAGS_O3_NON_NATIVE, "$ORIGINAL_CXXFLAGS")
    fi
