        ...
        class ParentMethods:
            ...
            def dual(self):
                ...
                EXAMPLES::
                    ...
                    sage: W = ExtendedAffineWeylGroup(['B',3,1])
                    sage: W.dual()
                ...
                DW = ExtendedAffineWeylGroup(E.cartan_type().dual(), Family({"affine":E._prefixaf,"classical":E._prefixcl,"translation":E._prefixt,"fundamental":E._prefixf}), print_tuple=E._print_tuple)
                if self == E.PW0():
        ...
        class ElementMethods:
            ...
            def to_dual(self):
                ...
                EXAMPLES::
                    ...
                    sage: W = ExtendedAffineWeylGroup(['B',2,1])
    ...
    class ExtendedAffineWeylGroupPW0Element(GroupSemidirectProduct.Element):
        ...
        def to_dual(self):
            ...
            EXAMPLES::
                ...
                sage: w = ExtendedAffineWeylGroup(['B',2,1]).an_element(); w
                t[2*Lambdacheck[1] + 2*Lambdacheck[2]] * s1*s2
                sage: w.to_dual()
    ...
    class ExtendedAffineWeylGroupW0PElement(GroupSemidirectProduct.Element):
        ...
        def to_dual(self):
            ...
            EXAMPLES::
                ...
                sage: w = ExtendedAffineWeylGroup(['B',2,1],style="W0P").an_element(); w
    ...
    class ExtendedAffineWeylGroupWFElement(GroupSemidirectProduct.Element):
        ...
        def to_dual(self):
            ...
            EXAMPLES::
                ...
                sage: w = ExtendedAffineWeylGroup(['B',2,1],style="WF").an_element(); w
                S1*S0*S2 * pi[1]
                sage: w.to_dual()
                S1*S0*S2 * pi[1]
    ...
    class ExtendedAffineWeylGroupFWElement(GroupSemidirectProduct.Element):
        ...
        def to_dual(self):
            ...
            EXAMPLES::
                ...
                sage: w = ExtendedAffineWeylGroup(['B',2,1],style="FW").an_element(); w
                pi[1] * S1*S0*S2
                sage: w.to_dual()
                pi[1] * S1*S0*S2
