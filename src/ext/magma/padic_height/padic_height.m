...
/*****************************************************************
 ...
 (c) 2005, William Stein, wstein@ucsd.edu
...
INPUT:
   ...
   return E2_c4c6(c4, c6, p, prec);
end intrinsic;


intrinsic E2_c4c6(c4::., c6::., p::RngIntElt, prec::RngIntElt) -> .
{
Returns value of E2 on the elliptic curve with given c4 and c6 invariants
and the matrix of frob on omega=dx/y, eta = x*dx/y.
...
intrinsic regulator(E::CrvEll, p::RngIntElt, prec::RngIntElt, points::SeqEnum) -> .
{
   Computes and returns the p-adic regulator of E, which is the
   discriminant of the height pairing on the Mordell-Weil group E(Q).
...
Email from Mazur:
[B] computing p-adic height matrices for quadratic twists
