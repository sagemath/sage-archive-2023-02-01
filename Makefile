...
misc-clean:
	@echo "Deleting built artifacts generated by autoconf, automake, make ..."
	rm -rf logs
	rm -rf dist
	rm -rf tmp
...
bdist-clean: clean
	$(MAKE) misc-clean
	@echo "Deleting built artifacts generated by configure ..."
	rm -f config.status
...
# doctests.
micro_release: misc-clean sagelib-clean
