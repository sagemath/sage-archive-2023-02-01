...
from sage.libs.polybori.easy_polynomials import (easy_linear_polynomials as
...
def multiply_polynomials(l, ring):
    """
    >>> from sage.libs.polybori import Ring
    >>> from sage.libs.polybori.nf import multiply_polynomials
    >>> r=Ring(1000)
    >>> x=r.variable
...
def normal_form(poly, ideal, reduced=True):
    ...
    >>> from sage.libs.polybori import declare_ring, normal_form
