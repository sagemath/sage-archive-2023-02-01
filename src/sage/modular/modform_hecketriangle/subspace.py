...
def ModularFormsSubSpace(*args):
    r"""
    Create a modular forms subspace generated by the supplied arguments if possible.
    The corresponding ambient space is choosen as small as possible.
    ...
    EXAMPLES::
        ...
        sage: ModularFormsSubSpace(MF.E4()^3-MF.E6()^2).ambient_space()
    ...
    if (not isinstance(ambient_space, FormsSpace_abstract)):
        raise Exception("Generators don't lie in a common ambient space!")
