...
class QuaternionOrder(Algebra):
    ...
    def random_element(self, *args, **kwds):
        ...
        where e_1, ... e_4 are the basis of this order and a, b, c, d
        are random integers.
...
class QuaternionFractionalIdeal_rational(QuaternionFractionalIdeal):
    ...
    def basis_matrix(self):
        ...
        If Q is the ambient quaternion algebra, then the ZZ-span of the rows of M
        viewed as linear combinations of Q.basis() = [1,i,j,k] is the fractional
        ideal self.  Also, M * M.denominator() is an integer matrix in Hermite
        normal form.
    ...
    def free_module(self):
        """
        Return the free module associated to this quaternionic fractional
        ideal, viewed as a submodule of Q.free_module(), where Q is the
