...
SageMath. The first two ones regard vector calculus in the 3-dimensional
Euclidean space :math:`\mathbb{E}^3` in a given coordinate system
(Cartesian, spherical and cylindrical coordinates). The third
tutorial is devoted to changes between the above three coordinate systems. The
fourth tutorial presents some advanced aspects, namely the treatment of
...
features of the first four tutorials.
...
.. toctree::
   ...
   vector_calculus/euclidean_plane
