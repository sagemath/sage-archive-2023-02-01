...
There are two main classes, ConjugacyClass and ConjugacyClassGAP.
All generic methods should go into ConjugacyClass, whereas
ConjugacyClassGAP should only contain wrappers for GAP functions.
ConjugacyClass contains some fallback methods in case some group cannot be
...
class ConjugacyClass(Parent):
    ...
    def __cmp__(self, other):
        r"""
        Comparison of conjugacy classes is done by comparing the underlying sets
    ...
    def __contains__(self, element):
        r"""
        Checks if an element belongs to the conjugacy class
    ...
    def list(self):
        r"""
        Returns a list with all the elements of the conjugacy class.
    ...
    def is_real(self):
        """
        Checks if the conjugacy class is real (closed for inverses) and
    ...
    def is_rational(self):
        """
        Checks if the conjugacy class is rational (closed for powers) and
        returns a boolean value.
    ...
    def parent(self):
        """
        Returns the ambient group. of the conjugacy class.
    ...
    def representative(self):
        """
        Returns a representative of the conjugacy class.
...
class ConjugacyClassGAP(ConjugacyClass):
    ...
    def _gap_(self):
        r"""
        Returns the gap object corresponding to the conjugacy class
    ...
    def set(self):
        r"""
        Returns a Sage Set with all the elements of the conjugacy class.
        ...
        is finite, falls back to a naive algorithm. Beware the naive
        algorithm can be really slow and memory intensive.
