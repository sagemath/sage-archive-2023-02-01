    ...
    class Element(CombinatorialFreeModule.Element):
        def _acted_upon_(self, scalar, self_on_left=False):
            ...
            EXAMPLES::
                ...
                sage: s1,s2 = G.gens()
                sage: x = R.an_element(); x
                B[s2*s1*s2*s1] + 2*B[s1*s2*s1] + 3*B[s2*s1*s2] + B[s1*s2]
                sage: 2 * x
                2*B[s2*s1*s2*s1] + 4*B[s1*s2*s1] + 6*B[s2*s1*s2] + 2*B[s1*s2]
                sage: s1 * x
                3*B[s2*s1*s2*s1] + B[s2*s1*s2] + 2*B[s2*s1] + B[s2]
                sage: s2 * x
                2*B[s2*s1*s2*s1] + B[s1*s2*s1] + B[s2*s1*s2] + 3*B[s1*s2]
                ...
                B[s2*s1*s2*s1] + 2*B[s1*s2*s1] + 3*B[s2*s1*s2] + B[s1*s2]
                sage: x * s1
                3*B[s2*s1*s2*s1] + B[s1*s2*s1] + B[s2*s1*s2] + 2*B[s1*s2]
                sage: x * s2
                ...
                2*B[s2*s1*s2*s1] + B[s1*s2*s1] + B[s2*s1*s2] + 3*B[s1*s2]
                sage: (2*s1 - s2) * x
                4*B[s2*s1*s2*s1] - B[s1*s2*s1] + B[s2*s1*s2] - 3*B[s1*s2] + 4*B[s2*s1] + 2*B[s2]
                sage: (3*s1 + s2) * R.zero()
                0
