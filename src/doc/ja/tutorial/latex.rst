...
連結グラフの作画には，PGFライブラリの新しいバージョンに加えて ``tkz-graph.sty`` が https://www.ctan.org/pkg/tkz-graph から必要で，さらに ``tkz-arith.sty``　とおそらく ``tkz-berge.sty`` も https://www.ctan.org/pkg/tkz-berge から 必要になる.
