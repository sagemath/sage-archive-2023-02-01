...
def padic_lseries(self, p, normalize='L_ratio', use_eclib=False):
    ...
    We can use eclib to compute the `L`-series::
        ...
        2 + 3 + 3^2 + 2*3^3 + 2*3^5 + 3^6 + O(3^7) + (1 + 3 + 2*3^2 + 3^3 + O(3^4))*T + (1 + 2*3 + O(3^4))*T^2 + (3 + 2*3^2 + O(3^3))*T^3 + (2*3 + 3^2 + 2*3^3 + O(3^4))*T^4 + (2 + 2*3 + 2*3^2 + O(3^4))*T^5 + (1 + 3^2 + O(3^3))*T^6 + (2 + 3^2 + 2*3^3 + O(3^4))*T^7 + (2 + 2*3 + 2*3^2 + 3^3 + O(3^4))*T^8 + (2 + O(3^2))*T^9 + O(T^10)
