...
class IndexedSequence(SageObject):
    ...
    def dct(self):
        ...
        EXAMPLES:
            ...
            Indexed sequence: [2.50000000000011 + 0.00000000000000566213742558829*I, 2.50000000000011 + 0.00000000000000566213742558829*I, 2.50000000000011 + 0.00000000000000566213742558829*I, 2.50000000000011 + 0.00000000000000566213742558829*I, 2.50000000000011 + 0.00000000000000566213742558829*I]
                indexed by [0, 1, 2, 3, 4]
        """
        F = self.base_ring()   ## elements must be coercible into RR
        J = self.index_object()   ## must be = range(N)
    ...
    def dst(self):
        ...
        EXAMPLES:
            ...
            Indexed sequence: [0.0000000000000170419234279961 - 2.49999999999915*I, 0.0000000000000170419234279961 - 2.49999999999915*I, 0.0000000000000170419234279961 - 2.49999999999915*I, 0.0000000000000170419234279961 - 2.49999999999915*I, 0.0000000000000170419234279961 - 2.49999999999915*I]
                indexed by [0, 1, 2, 3, 4]
        """
        F = self.base_ring()   ## elements must be coercible into RR
        J = self.index_object()   ## must be = range(N)
