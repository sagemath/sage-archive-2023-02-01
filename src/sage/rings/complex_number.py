...
class ComplexNumber(ring_element.RingElement):
    ...
    def cotan(self):
        ...
        EXAMPLES:
            ...
            0.21762156185440268136513424360523807352075436916785404091068124239236 - 0.86801414289592494863584920891627388827343874994609327121115071646176*I   # 64-bit
        """
