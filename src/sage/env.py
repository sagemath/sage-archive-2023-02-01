...
FOURTITWO_HILBERT = var("FOURTITWO_HILBERT", "hilbert")
FOURTITWO_MARKOV = var("FOURTITWO_MARKOV", "markov")
FOURTITWO_GRAVER = var("FOURTITWO_GRAVER", "graver")
FOURTITWO_ZSOLVE = var("FOURTITWO_ZSOLVE", "zsolve")
FOURTITWO_QSOLVE = var("FOURTITWO_QSOLVE", "qsolve")
FOURTITWO_RAYS = var("FOURTITWO_RAYS", "rays")
FOURTITWO_PPI = var("FOURTITWO_PPI", "ppi")
FOURTITWO_CIRCUITS = var("FOURTITWO_CIRCUITS", "circuits")
FOURTITWO_GROEBNER = var("FOURTITWO_GROEBNER", "groebner")
