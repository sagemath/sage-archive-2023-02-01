...
class ComplexReflectionGroups(Category_singleton):
    ...
    .. NOTE::
        ...
        Several of the notions and methods of this category are common
        with the category of generalized Coxeter groups. In the
        current state of the art, there is no clear mathematic
        definition of what should be the correct super category of
        both. Hence this super category is not defined in Sage, and
        the common code is share thanks to aliases from this category
        to that of generalized coxeter groups.
    ...
    class SubcategoryMethods:
        Irreducible = GeneralizedCoxeterGroups.SubcategoryMethods.Irreducible.im_func
    ...
    class ParentMethods:
        ...
        # TODO go through this, and remove duplication with GeneralizedCoxeterGroups
