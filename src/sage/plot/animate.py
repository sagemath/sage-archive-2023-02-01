...
An animated :class:`sage.plot.multi_graphics.GraphicsArray` of rotating ellipses::
...
class Animation(WithEqualityById, SageObject):
    ...
    def graphics_array(self, ncols=3):
        r"""
        Return a :class:`sage.plot.multi_graphics.GraphicsArray` with plots of the
        frames of this animation, using the given number of columns.
        The frames must be acceptable inputs for
        :class:`sage.plot.multi_graphics.GraphicsArray`.
