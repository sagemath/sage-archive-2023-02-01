...
def carlet_tang_tang_liao(n, c=None, f=None):
    r"""
    ...
    def f(x):
        ...
        if xprime == 0:
            res = [0]*(n-1), f_one(xprime/c) + xs[-1]
        elif xs[-1] == 0:
            res = (1/xprime).polynomial().list(), f_one(xprime)
        else:
            res = (c/xprime).polynomial().list(), f_one(xprime/c) + 1
