...
@our_debian = ('cddlib', 'eclib', 'flint', 'flintqs', 'libfplll','genus2reduction','gfan','givaro','iml','lcalc','libm4ri','linbox','ntl','palp','singular','symmetrica','sympow','tachyon','rubiks','scipy_sandbox');
