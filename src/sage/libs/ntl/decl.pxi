...
cdef extern from "ntl_wrap.h":
    ...
    void ZZ_GenPrime "GenPrime"(ZZ_c n, long l, long err = 80)
    void ZZ_GenGermainPrime "GenGermainPrime"(ZZ_c n, long l, long err = 80)
    long ZZ_ProbPrime "ProbPrime"(ZZ_c n, long NumTrials = 10)
    void ZZ_RandomPrime "RandomPrime"(ZZ_c n, long l, long NumTrials = 10)
    void ZZ_NextPrime "NextPrime"(ZZ_c n, ZZ_c m, long NumTrials = 10)
