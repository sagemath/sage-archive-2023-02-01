...
class SPTCrystal(UniqueRepresentation, Parent):
    ...
    def __classcall_private__(cls, *args, **kwargs):
        ...
        if n+1 < len(shape):
            raise ValueError('invalid crystal index')
...
# Helper function, preprocessing of the input array to fit
# Shifted Primed Tableau format.
            ...
            for element in row:
                ...
                if isinstance(element, str):
                    ...
                    try:
                        ...
                        raise ValueError(
                            "invalid input for primed elements")
            t.append(row_new)
